...
/// Half the distance between the two fingers. It has to be a hand's width and
/// not a token 50 px: a twist moves each finger along a chord of this radius,
/// and below Flutter's own scale slop the gesture is never recognised at all -
/// which reads in a test as a rotation threshold far higher than the one set.
const _reach = 120.0;
