/// The reader for the binary map frames. The constants must stay identical to
/// `commuterlviv/live/wire.py`: a frame carries no box of its own. Ten bytes
/// per vehicle, read into flat typed lists with no per-vehicle allocation.
library;
...
/// Bit 0: the position is extrapolated rather than reported.
const staleFlag = 1;

/// Bit 1: the vehicle is under way, so its direction is worth drawing.
const movingFlag = 2;
