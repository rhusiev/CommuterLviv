...
class StopCard extends StatefulWidget {
  ...
  /// Only the initial state: the screen behind cannot rebuild a sheet, so the
  /// card tracks its own taps from here.
  final bool pinned;
  ...
  /// The line, on a long press: a tap picks the route to watch.
