...
/** Sign in, register, or take up an invite. Which of the three the server allows
 * is its `COMMUTERLVIV_REGISTRATION`, read from `/api/health`. */
      ...
      <form onSubmit={submit} className="panel w-full max-w-sm space-y-4 p-6">
        ...
        <label className="block">
          ...
          <input
            ...
            // Older password managers key off the name, newer off autoComplete
            name="username"
