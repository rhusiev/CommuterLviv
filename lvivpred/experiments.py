...
def _markdown(d, variants):
    ...
    out = ["# Approaches, and what each one scored", "",
           f"One recording: {d['crossings']} unambiguous stop crossings over "
           ...
           "check the 95% intervals in `approaches.json`: they are resampled over "
           "whole trips, and on a recording this short several of these gaps sit "
           "inside them.", "",
