...
Nothing here has a default that is unsafe in production. Two settings have no
default at all - the database and the cookie policy - because guessing either
one wrong is how a service ends up serving session cookies over plain HTTP.
"""
import os
