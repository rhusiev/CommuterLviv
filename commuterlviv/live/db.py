...
Migrations are numbered files in `migrations/`, applied in order inside one
transaction each, with the number recorded. There is no down direction: a
service this size rolls forward or restores, and a half-written down migration
